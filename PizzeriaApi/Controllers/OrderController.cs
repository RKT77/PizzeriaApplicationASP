...
namespace PizzeriaApi.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(IDeleteOrder deleteOrder,IAddOrderItem addOrderItem,IGetOrders getOrders,IGetOrder getOrder, IChangeStatus changeStatus, IChangeTable changeTable, ISubtractItemsOrder decreaseItemsOrder)
        {
        ...
        // POST: api/Order
        /// <summary>
        /// Creates Order or updates a OrderItem of the current Order.
        /// </summary>
        /// <remarks>
        /// Sample request:
        ///
        ...
        /// <response code="400">If the Table,Attendant or Item is null</response>    
        [HttpPost]
        public IActionResult Post([FromBody] OrderRequest value)
        {
            try
            {
                this.addOrderItem.Execute(value);
                return NoContent();
            }
            catch(NotFoundObjectException e)
            {
        ...
        /// <returns>No Content</returns>
        /// <response code="204">Returns No Content</response>
        /// <response code="400">if the status is not paid or cancelled</response>
        ...
        /// <returns>No Content</returns>
        /// <response code="204">Returns No Content</response>
        /// <response code="400">If the Item doesnt exist, or if DeleteAll is not 0 or 1</response>
        [HttpPut("Subtract/{id}")]
        [LoggedIn]
        public IActionResult Subtract(int id,[FromBody] ItemSubtractRequest value)
        {
            try
            {
                this.decreaseItemsOrder.Execute(value, id);
                return NoContent();
            }
            catch(ObjectDoesntExistException e)
            {
